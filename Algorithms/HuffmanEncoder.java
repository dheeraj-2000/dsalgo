...
public class HuffmanEncoder {
    ...
    private void traverse(Node node, String psf) { // traversing the tree of the string for replacing the values with 0's and 1's.
	...
	public String Encode(String str){ // Encode the string
		String code="";
	...
	public String Decode(String str){ // Decode the string
      String decode="";
      String prefix="";
      for(int i=0;i<str.length();i++){
    	  prefix+=str.charAt(i);
